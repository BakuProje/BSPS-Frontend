...
async function submitReport(event) {
    ...
    try {
        ...
        whatsappButton.href = 'https://api.whatsapp.com/send?phone=6281527641306&text=Welcome%20To%20BSPS%20Support%0A%0AGrowid%3A%0ATanggal%3A${encodeURIComponent(formatDateTime(new Date()))}%0AMasalah%3A"';
    ...
    if (data.message === 'Kalau mau chat Owner langsung silahkan klik di bawah ini' || data.isWhatsAppButton) {
        whatsappButton = `
            <div class="whatsapp-button-container" style="margin-top: 10px;">
                <a href="https://api.whatsapp.com/send?phone=6281527641306&text=Welcome%20To%20BSPS%20Support%0A%0AGrowid%3A%0ATanggal%3A${encodeURIComponent(formatDateTime(new Date()))}%0AMasalah%3A" 
